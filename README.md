...
I use AI extensively as an augmented version of traditional search engines, so I don't spend too much time looking for specific things when I can just ask for them, but I don't allow AI to touch my code or to avoid learning complex subjects. The only instances where I ask to generate code is for annoying tasks that interferes with meaninful work, like writing glue TypeScript code for the Objective.ink Safari extension, a totally meaningless integration with browser APIs when the imortant work is on the stylesheets themselves, that provide aesthetic solutions to website problems.
